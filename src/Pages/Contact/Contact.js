    ...
    <div className="lg:h-screen lg:mb-0 mb-20 flex flex-col justify-center container mx-auto lg:px-20 px-5 pt-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 mt-10 lg:space-x-20">
          ...
          <ul className="leading-7">
            ...
            <li className="flex items-center">
              ...
              <div className="info">
                ...
                <p className="font-semibold">aminulislamorange@gmail.com</p>
              </div>
            </li>
            <li className="flex items-center">
              <FontAwesomeIcon
              ...
              <div className="info">
                ...
                <p className="font-semibold">01727302486</p>
              </div>
            </li>
          </ul>
          <div className="flex mt-5 mb-5">
            <a href="https://www.facebook.com/orange.K15">
              {" "}
              <FontAwesomeIcon
            ...
            <a href="https://www.linkedin.com/in/aminul-islam-orange/">
              {" "}
              <FontAwesomeIcon
                className="text-white text-3xl bg-slate-900 p-3 rounded-full cursor-pointer mr-3"
                icon={faLinkedin}
        ...
        <div className="contact-form col-span-2">
          <form
            action="https://getform.io/f/b262941b-4fb5-4e49-86d6-711a175078f0"
            method="POST"
          >
