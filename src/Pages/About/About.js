      ...
      <div class="hero mb-20 mt-10">
        <div class="hero-content flex-col-reverse justify-between lg:flex-row-reverse lg:px-40">
          <div className="text-left">
            ...
            <a href="https://drive.google.com/file/d/1I02FVuRyCaJVmguQsffLjjir9RW7wf8M/view?usp=sharing"   class="btn btn-secondary text-white px-10 rounded-full" target="_blank" rel="noreferrer">
              Download Resume
