...
const Navbar = () => {
  ...
  const menu = (
    <>
      ...
      >
        <a
          href="https://drive.google.com/file/d/1I02FVuRyCaJVmguQsffLjjir9RW7wf8M/view?usp=sharing
          " 
          className="btn btn-circle btn-info text-white" rel="noreferrer" target="_blank"
        >
    ...
    <>
      ...
      >
        <CustomLink to="/blogs">
          ...
          >
            <a
              href="https://drive.google.com/file/d/1WCBdlUYTcK7yEdoP66q579jaS6e2llMq/view?usp=sharing
              "
